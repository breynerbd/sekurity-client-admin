...
export const Sidebar = () => {
    ...
    // Definimos los items con sus respectivos iconos SVG de seguridad
    const items = [
        ...
        { id: "ratings", label: "Calificaciones", icon: <path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.175 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.382-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" /> },
    ];

    return (
        <aside className="w-72 bg-white min-h-[calc(100vh-5rem)] p-6 border-r border-gray-100 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            <nav>
            ...
            {/* Tarjeta de soporte estilo Kafetery pero con colores Sekurity */}
            <div className="mt-10 pt-6 border-t border-gray-100">
                <div className="bg-blue-600 rounded-2xl p-5 text-center shadow-lg shadow-blue-900/20">
                    ...
                    <p className="text-[9px] text-white/80 leading-relaxed">
                        Sistema de vigilancia y reportes ciudadana v2.0
                    </p>
                </div>
            </div>
        </aside>
